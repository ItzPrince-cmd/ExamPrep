...
interface QuestionBankFeatureProps {
  scrollProgress: MotionValue<number>;
}

export function QuestionBankFeature({ scrollProgress }: QuestionBankFeatureProps) {
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Largest Question Bank for
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary"> JEE & NEET</span>
          </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2">
                    {["A", "B", "C", "D"].map((option) => (
                      <motion.div
                        key={option}
                        className="option-circle border border-border rounded-md p-2 text-center cursor-pointer"
                        whileHover={{ 
