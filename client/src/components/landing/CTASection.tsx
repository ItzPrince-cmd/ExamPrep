      ...
      <div className="max-w-7xl mx-auto w-full py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div 
              className="h-14 w-14 bg-primary/10 text-primary rounded-xl flex items-center justify-center mb-6"
            ...
            <div className="relative z-10">
              <Link href="/signup?role=student">
                ...
                >
                  <Button 
                    className="w-full bg-gradient-to-r from-primary to-primary-600 hover:opacity-90 text-white group"
                    size="lg"
                  >
          ...
          >
            ...
            <motion.div 
              className="h-14 w-14 bg-secondary/10 text-secondary rounded-xl flex items-center justify-center mb-6"
              whileHover={{ scale: 1.05 }}
            >
              <Users size={30} />
            </motion.div>
            ...
            <div className="relative z-10">
              <Link href="/signup?role=teacher">
                ...
                >
                  <Button 
                    className="w-full bg-gradient-to-r from-secondary to-accent hover:opacity-90 text-white group"
                    size="lg"
                  >
