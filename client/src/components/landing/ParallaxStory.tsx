      ...
      <div className="w-full px-4 py-20 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            We've built a platform that empowers both students and teachers, creating a seamless 
            educational ecosystem for better learning outcomes and teaching efficiency.
          </p>
        </motion.div>
        
        {/* Main content container - improved spacing */}
        <div className="relative h-[800px] md:h-[900px] w-full max-w-6xl mx-auto mt-12">
          ...
          >
            <motion.div 
              animate={{ 
                boxShadow: ["0 0 30px rgba(79, 70, 229, 0.3)", "0 0 60px rgba(79, 70, 229, 0.6)", "0 0 30px rgba(79, 70, 229, 0.3)"] 
              }}
          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                animate={{
                  boxShadow: ["0 0 10px rgba(124, 58, 237, 0.1)", "0 0 20px rgba(124, 58, 237, 0.2)", "0 0 10px rgba(124, 58, 237, 0.1)"]
                }}
                transition={{
                  duration: 3,
                  repeat: Infinity,
