...
export function DashboardPreview({ scrollProgress }: DashboardPreviewProps) {
                    ...
                    <div className="col-span-12 md:col-span-4 space-y-6">
                          ...
                          {[
                            ...
                            <motion.div
                              ...
                              className={`p-2.5 border rounded-md flex items-center gap-2 ${
                                item.urgent ? "border-red-200 bg-red-50/50 dark:bg-red-900/10 dark:border-red-900/30" : "border-border"
                              }`}
                              initial={{ opacity: 0, y: 10 }}
                              animate={{ opacity: 1, y: 0 }}
                              transition={{ delay: 0.8 + index * 0.1 }}
                              whileHover={{ backgroundColor: item.urgent ? "rgba(254, 226, 226, 0.6)" : "rgba(79, 70, 229, 0.05)" }}
                            >
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Button variant="secondary" size="sm" className="bg-white/80 hover:bg-white dark:bg-background/80 dark:hover:bg-background text-secondary">
                            <Layers size={14} className="mr-1" />
                            New Test
                          </Button>
                          <Button variant="secondary" size="sm" className="bg-white/80 hover:bg-white dark:bg-background/80 dark:hover:bg-background text-primary">
